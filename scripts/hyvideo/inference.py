...
from arnr.hyvideo import HunyuanVideoMeterPipeline, apply_rnr
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--model_name", type=str, choices=["hyvideo"], required=True)
    ...
    parser.add_argument(
        "--flow_shift", type=float, default=5.0, 
        help=(
    ...
    parser.add_argument("--video_size", type=int, nargs=3, default=[129, 544, 960])
